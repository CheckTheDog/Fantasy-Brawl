...
bool j1UIScene::Update(float dt)
{
	...
	hp_bar1->localPosition.x = App->scene->player1->Entityinfo.position.x - App->scene->player1->Entityinfo.entitycoll->rect.w * 4.25f  * scale;
	hp_bar1->localPosition.y = App->scene->player1->Entityinfo.position.y - 100;				 
	hp_bar2->localPosition.x = App->scene->player2->Entityinfo.position.x - App->scene->player2->Entityinfo.entitycoll->rect.w * 4.25f  * scale;
	hp_bar2->localPosition.y = App->scene->player2->Entityinfo.position.y - 100;				 
	hp_bar3->localPosition.x = App->scene->player3->Entityinfo.position.x - App->scene->player3->Entityinfo.entitycoll->rect.w * 4.25f  * scale;
	hp_bar3->localPosition.y = App->scene->player3->Entityinfo.position.y - 100;				 
	hp_bar4->localPosition.x = App->scene->player4->Entityinfo.position.x - App->scene->player4->Entityinfo.entitycoll->rect.w * 4.25f  * scale;
	hp_bar4->localPosition.y = App->scene->player4->Entityinfo.position.y - 100;				 
																								 
	//UPDATING SP BARS POSITION																	 
	sp_bar1->localPosition.x = App->scene->player1->Entityinfo.position.x - App->scene->player1->Entityinfo.entitycoll->rect.w * 4.25f  * scale;
	sp_bar1->localPosition.y = App->scene->player1->Entityinfo.position.y - 75;				 
	sp_bar2->localPosition.x = App->scene->player2->Entityinfo.position.x - App->scene->player2->Entityinfo.entitycoll->rect.w * 4.25f  * scale;
	sp_bar2->localPosition.y = App->scene->player2->Entityinfo.position.y - 75;				 
	sp_bar3->localPosition.x = App->scene->player3->Entityinfo.position.x - App->scene->player3->Entityinfo.entitycoll->rect.w * 4.25f  * scale;
	sp_bar3->localPosition.y = App->scene->player3->Entityinfo.position.y - 75;				 
	sp_bar4->localPosition.x = App->scene->player4->Entityinfo.position.x - App->scene->player4->Entityinfo.entitycoll->rect.w * 4.25f  * scale;
